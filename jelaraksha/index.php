    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg stroke px-0">
        <h1> <a class="navbar-brand" href="index.html">
            Jela<span class="sublog">raksha.</span>
          </a></h1>
      ...
      <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-lg-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="publicReg.php">Public <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              ...
              <div class="banner-info">
                <div class="container">
                  ...
                  <div class="banner-info-bg">
                    <h5>Protect Jellife, protect nature. </h5>
          ...
          <li>
            <div class="slider-info  banner-view banner-top1 bg bg2">
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg">
                    <h5>Save Jellife and Jellife will save you. </h5>
                    <p class="mt-md-4 mt-3">Lorem ipsum dolor sit amet consectetur ipsum elit. Qui eligendi vitae sit.Ea
                      ipsum sed consequuntur illum facere.
                    </p>
                    <a class="btn btn-style btn-white mt-sm-5 mt-4 mr-2" href="#read"> Discover Now
        ...
        <div class="row footer-top-29">
          <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
            <div class="footer-logo mb-3">
              <a class="footer-brand-logo" href="index.html">Jel<span class="sublog">live.</span></a>
